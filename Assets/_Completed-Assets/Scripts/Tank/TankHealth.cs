...
namespace Complete
{
    public class TankHealth : MonoBehaviour
    {
        ...
        private void OnDeath()
        {
            ...
            m_Dead = true;
            GameObject.Find("GameManager").GetComponent<GameManager>().tankPlaying--;
            GameObject.Find("GameManager").GetComponent<GameManager>().ReconfigureCamera(this.GetComponent<TankMovement>().m_PlayerNumber);
            
            //     this.GetComponent<GameManager>().ReconfigureCamera(2);
